...
export const initContacts = ()=> {
  ...
  const novosibirskaya__oblast = document.querySelector('.novosibirskaya__oblast');
  const baloon4 = document.querySelector('.information__baloon-4');

  if (novosibirskaya__oblast) {
    novosibirskaya__oblast.addEventListener('mouseenter', function() {
      baloon4.classList.add('active')
    })

    novosibirskaya__oblast.addEventListener('mouseleave', function() {
      baloon4.classList.remove('active')
    })
  }
