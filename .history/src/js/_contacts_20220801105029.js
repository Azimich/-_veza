...
export const initContacts = ()=> {
  ...
  const kurganskaya__oblast = document.querySelector('.kurganskaya__oblast');
  const baloon14 = document.querySelector('.information__baloon-14');

  if (kurganskaya__oblast) {
    kurganskaya__oblast.addEventListener('mouseenter', function() {
      baloon14.classList.add('active')
    })

    kurganskaya__oblast.addEventListener('mouseleave', function() {
      baloon14.classList.remove('active')
    })
  }
